## TRAIN AND EVALUATE NATIONAL LSTM MODEL ##
...
run = input("run name: ")
func_sites = input("function for sites (get_sites_full or get_sites_random or get_sites_longitude or get_sites_latitude): ") 
...
## GET SNOTEL SITES ##
snotel = func_map_site[func_sites](num_sites)
